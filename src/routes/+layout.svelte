...
<div class="layout">
  <nav class="navbar {isScrolled ? 'scrolled' : ''}">
    ...
    <div class="nav-controls">
      ...
      <button class="icon-btn" onclick={cycleTheme} title="Cycle Theme"
        >THEME</button
      >
      <a href="https://github.com/nullclaw/nullhub" target="_blank" class="github-btn"
        >GITHUB</a
      >
    </div>
  </nav>
  ...
  <footer>
    <div class="footer-content">
      <p>NullHub — Ecosystem management hub for NullClaw infrastructure</p>
      ...
      <div class="terminal-line">root@nullhub:~# manage --ecosystem _</div>
    </div>
  </footer>
</div>
